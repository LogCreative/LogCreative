...
\section{目前进度}
    ...
    主页方面暂缓。先做 \LaTeX{} 视频，仍然可以学一些前端知识。视频制作方向有点迷茫，打算先翻译一些著名的文献以寻找灵感：\href{https://github.com/LogCreative/learnlatex.github.io}{learnlatex.github.io}（已经通过了 $\mathbb{C}$\TeX{} 的第一个 Pull Request！）。
