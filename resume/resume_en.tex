...
\begin{document}
    ...
    \begin{cvitems}
        \item[Programming] 
        \begin{subcvitems}
            \item[\faCheck] Familiar with \textsf{C/C++}\githublink{GraphGenDecomp} (FLTK), \textsf{VB{\scriptsize .NET}/C\#\,} \githublink{ClassBookController} \githublink{DialogCreator}、排版程式 \textsf{\LaTeX}\,\githublink{AutoBeamer}相关的界面编程。\rightnote{2015--2021}
        ...
        \begin{subcvitems}
            ...
            \item[\faCaretSquareORight\hskip1.15pt] 参与过 \textsf{VS Code} 中文社区线下活动，完成 2021 年微软开源学习社群实践项目\githublink{mnist-calculator} \githublink{custom-tensor-op}\githublink{qlib-CNN}。\rightnote{2021} 
        \end{subcvitems}
    \end{cvitems}
